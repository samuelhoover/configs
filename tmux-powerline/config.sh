...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/q3/lfzvcqd97_q0vvhx191jh1lm0000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/samhoover/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/samhoover/.mailcheckrc"
# }
...
# weather.sh {
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="42.409516"
	TMUX_POWERLINE_SEG_WEATHER_LON="-72.527535"
# }
